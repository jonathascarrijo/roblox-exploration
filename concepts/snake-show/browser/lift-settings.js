...
(function (root) {
  ...
  const SLIDERS = [
    ...
    ['g', 'Motors', 'Gravity', 1, 5, .1, 1, 'u/s²', 'Scales the load on each cable and the capsule’s slide.'],
    ['pulse', 'Motors', 'Tap pulse', .05, .5, .05, 2, 's', 'Minimum motor-on time for a quick tap.'],
    ['ballW', 'Prize', 'Prize weight', .3, 3, .1, 1, '× tray weight', 'A heavier capsule increases the difference between cable loads.'],
    ['roll', 'Prize', 'Slide response', .2, 2, .1, 2, '× slope', 'How strongly tilt accelerates the capsule.'],
    ['cb', 'Prize', 'Slide drag', 0, 3, .1, 1, '', 'Speed-dependent resistance to the sliding capsule.'],
    ['mus', 'Prize', 'Static friction', 0, .6, .01, 2, '', 'The capsule holds still until tilt × slide response exceeds this.'],
    ['muk', 'Prize', 'Sliding friction', 0, .6, .01, 2, '', 'Constant resistance after the capsule starts sliding.'],
    ['x0', 'Prize', 'Start offset', .1, .8, .05, 2, 'half-lengths', 'Applies to the next capsule or practice restart; does not move a live capsule.'],
