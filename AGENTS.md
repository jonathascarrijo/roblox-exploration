...
Snake Show has two browser codebases under `concepts/snake-show/`. Their run,
test, and cache-busting rules live in `concepts/snake-show/AGENTS.md`. Read
that file before changing anything in that folder.
